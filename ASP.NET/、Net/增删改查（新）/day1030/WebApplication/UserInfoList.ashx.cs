    ...
    public class UserInfoList : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            TestService testService = new TestService();
             ...
             {
                 sb.AppendFormat("<tr><td>{0}</td><td>{1}</td><td>{2}</td><td>{3}</td><td>{4}</td><td><a href='userInfo.ashx?id={5}'>详情</a></td><td><a href='delete.ashx?id={5}' class='del'>删除</a></td><td><a href='update.ashx?id={5}'>修改</a></td></tr>"
