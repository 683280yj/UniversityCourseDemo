...
namespace Test.DAL
{
    public class UserInfoDal
    {
        ...
        public UserInfo GetEntityList(int id) {
            string str = "select * from hyq where 编号=@id";
        ...
        public int DeleteUserInfo(int id) {
            string str = "delete from hyq where 编号=@id";
        ...
        public int AddUserInfo() {
            string str = "insert into hyq(用户名,密码,邮箱,时间) values(@userName,@pwd,@email,@regtime)";
        ...
        public int UpdateUserInfo(int id) {
            string str = "update hyq set 用户名=@userName,密码=@pwd,邮箱=@email,时间=@regtime where 编号=@id";
            UserInfo userInfo = new UserInfo();
            SqlParameter[] pars ={
                                new SqlParameter("@userName", SqlDbType.NVarChar,32),
                                 new SqlParameter("@pwd", SqlDbType.NVarChar,32),
