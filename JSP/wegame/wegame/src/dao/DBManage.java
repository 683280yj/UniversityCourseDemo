...
//	static String url = "jdbc:sqlserver://localhost;databasename=CMR";
	//连接MySQL
	static String driver = "com.mysql.jdbc.Driver";
	static String url = "jdbc:mysql://127.0.0.1:3306/wegame?characterEncoding=UTF-8";
	//连接Oracle
...
//			con = DriverManager.getConnection(url,"sa","123");		//连接MSSQL
			con = DriverManager.getConnection(url,"CMR","0901");	//连接mysql
