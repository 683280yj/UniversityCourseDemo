...
<#--                <input type="text" value="${item.userPwd}">-->
                <#list list as item>
                    <div class="menu-hd MyShangcheng"><a href="selectUserInfo?userName=${item.userName}&userPwd=${item.userPwd}" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
                </#list>
            </div>
                ...
                <ul>
                    ...
                    <div class="mod-vip">
                        <div class="m-baseinfo">
                            ...
                            <em>
                                <#list list as item>
                                    Hi,<span class="s-name">${item.userNick}</span>
                                    <input type="hidden" value="${item.userName}">
                                    <input type="hidden" value="${item.userPwd}">
                                </#list>
