				...
				if('${user.userEmail}'==''){
					...
					$.ajax({
						...
						success:function (data){
							window.location.hash="#J_MiniCartNum";
			...
			<div class="am-container header">
				...
				<ul class="message-r">
					...
					<div class="topMessage my-shangcheng">
						<div class="menu-hd MyShangcheng"><a href="acceptaddress" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
					</div>
						...
						<div class="mod-vip">
							<div class="m-baseinfo">
								<#if Session["user"]?exists>
									...
									<em>
										<span class="s-name">${user.userEmail}</span>
							...
							<div class="member-logout">
								...
								<a class="am-btn-warning btn" href="webPage/register.html">注册</a>
							</div>
								</#if>
