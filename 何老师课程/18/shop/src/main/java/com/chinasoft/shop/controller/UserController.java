...
//    addressInsert
    ...
    public int addressInsert(HttpServletRequest request){
        Map<String,Object> map=new HashMap<>();
        map.put("userAddressPeople",request.getAttribute("userAddressPeople"));
        map.put("userPhone",request.getAttribute("userPhon"));
        map.put("userAddress",request.getAttribute("userAddress"));
        map.put("userEmail",request.getAttribute("userEmail"));
        return userService.addressInsert(map);
    }
